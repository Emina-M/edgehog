...
## [0.13.0](https://github.com/Emina-M/edgehog/compare/backend-v0.12.0...backend-v0.13.0) (2026-03-12)


### ⚠ BREAKING CHANGES

* **backend:** remove authentication bypass configuration
* events are treated as events ([#953](https://github.com/Emina-M/edgehog/issues/953))
...
* add `delete` operation support to deployment campaigns ([#1031](https://github.com/Emina-M/edgehog/issues/1031)) ([4d535d8](https://github.com/Emina-M/edgehog/commit/4d535d892d14278e5b9d5bef6a25ee54275638da))
...
* add Ash GraphQL subscriptions ([#1028](https://github.com/Emina-M/edgehog/issues/1028)) ([faefc93](https://github.com/Emina-M/edgehog/commit/faefc9380e1c5d4416618260c6100fecd481622a))
* add azure support ([ed8f2f7](https://github.com/Emina-M/edgehog/commit/ed8f2f75dcbdc53f01633d70396ac929ff4d4b0e))
* add calculation to expose Base Image name ([d3affa5](https://github.com/Emina-M/edgehog/commit/d3affa57af400440a26bccc6c29b3fb9c3534b23))
* Add container binds ([#1008](https://github.com/Emina-M/edgehog/issues/1008)) ([5e8d5e1](https://github.com/Emina-M/edgehog/commit/5e8d5e1bde6c2c11ed642a305318793df9209b92))
...
* Add Files Upload tab with manual file download request ([#1270](https://github.com/Emina-M/edgehog/issues/1270)) ([23f8951](https://github.com/Emina-M/edgehog/commit/23f895108d890b2f04fdd1db0f76e0724dacfe73))
* Add filtering for deployment targets with deployed applications ([#1002](https://github.com/Emina-M/edgehog/issues/1002)) ([c847e77](https://github.com/Emina-M/edgehog/commit/c847e77ecad9c35d5618b91687635682d7805475))
* add GraphQL subscriptions for containers ([#1224](https://github.com/Emina-M/edgehog/issues/1224)) ([6c36e6d](https://github.com/Emina-M/edgehog/commit/6c36e6d0e632251f64a6ffef4a2a304f658f55ad))
* add GraphQL subscriptions for OTA operations ([#1220](https://github.com/Emina-M/edgehog/issues/1220)) ([db679ce](https://github.com/Emina-M/edgehog/commit/db679ceebe687909871ed3fee9e59303b4397aa0))
* Add operation_type and target_release to deployment campaigns ([#999](https://github.com/Emina-M/edgehog/issues/999)) ([8d8b34e](https://github.com/Emina-M/edgehog/commit/8d8b34e2a74937e7ed1ac97fefd6dfc7f857921f))
* add start operation support to deployment campaigns ([#1017](https://github.com/Emina-M/edgehog/issues/1017)) ([1fe5bd1](https://github.com/Emina-M/edgehog/commit/1fe5bd1734109a1e5a49e8a48706ba9a762cf911))
* add stop operation support to deployment campaigns ([#1027](https://github.com/Emina-M/edgehog/issues/1027)) ([13a639a](https://github.com/Emina-M/edgehog/commit/13a639acbc7c6bbea1e60015f96f363790c07e6e))
* Add subscriptions for HT and SMPN ([#1225](https://github.com/Emina-M/edgehog/issues/1225)) ([7d46654](https://github.com/Emina-M/edgehog/commit/7d466541e3b77f87d84884332046a677d102b441))
...
* Add trigger delivery policies support to tenant reconciler ([#838](https://github.com/Emina-M/edgehog/issues/838)) ([8892e0f](https://github.com/Emina-M/edgehog/commit/8892e0f1bd60b123cd933af39436f86f5e148785))
* add upgrade operation support to deployment campaigns ([#1029](https://github.com/Emina-M/edgehog/issues/1029)) ([2eb965e](https://github.com/Emina-M/edgehog/commit/2eb965e354b67b1659c24dfcf296208f64f16ed6))
* add validation for deployment campaign operation type requirements ([#1004](https://github.com/Emina-M/edgehog/issues/1004)) ([396d995](https://github.com/Emina-M/edgehog/commit/396d9953347072117965d8eac07a87851e815cca))
* Additional information on deployment events ([ba27473](https://github.com/Emina-M/edgehog/commit/ba2747342f3b048a695f81deab856ce943aa39ab))
* allow administrators to delete tenants ([#1037](https://github.com/Emina-M/edgehog/issues/1037)) ([64300c3](https://github.com/Emina-M/edgehog/commit/64300c354e38d0c0c4661a778b3fcbcbc36929cb))
...
* **backend:** Add single file download request feature ([799479c](https://github.com/Emina-M/edgehog/commit/799479c474b3b67a9cf7eb3e62879d282ed3a0ab))
* **backend:** add subscriptions to campaigns domain ([2bda866](https://github.com/Emina-M/edgehog/commit/2bda8661d064a4eb45ade539058930e1b54ddefb))
* **backend:** allow deletion of BaseImage used in completed campaign ([46f7aa3](https://github.com/Emina-M/edgehog/commit/46f7aa34f585aabf2a37f4baef10a8ac4a5ea33d)), closes [#598](https://github.com/Emina-M/edgehog/issues/598)
* **backend:** allow devs to setup database connection ([649829a](https://github.com/Emina-M/edgehog/commit/649829af09106f283e6b929abec2987fbc7cd8fa))
* **backend:** base_images subscriptions ([bf28b85](https://github.com/Emina-M/edgehog/commit/bf28b85f909e6cfa1a2d8faf0979a4904073df67))
...
* **backend:** run tenant reconciliation at creation ([f806909](https://github.com/Emina-M/edgehog/commit/f806909c1159ffd6f9171885f8ccee96f2a6f582))
...
* create device upon registration in astarte ([#1007](https://github.com/Emina-M/edgehog/issues/1007)) ([05e8e16](https://github.com/Emina-M/edgehog/commit/05e8e16d3042a1c878d04ef8166d6c7cb25df688))
...
* expose is_ready field of deployment via GraphQL ([4b5064c](https://github.com/Emina-M/edgehog/commit/4b5064c7d05e5ba76795b2a66884bef5292fa8a0))
* expose underlying deployments ([73f21a6](https://github.com/Emina-M/edgehog/commit/73f21a69f8c93c0f9217ebf050a84bbbdf6b059d))
* expose underlying resources to the user ([a50e4fa](https://github.com/Emina-M/edgehog/commit/a50e4fa39dea68afe9e604ec5688a6ce005d87c8))
* filter deployment targets by operation type ([#1015](https://github.com/Emina-M/edgehog/issues/1015)) ([11541e2](https://github.com/Emina-M/edgehog/commit/11541e2c19160242180a557c0fe35fd74af05d66))
...
* implement GraphQL subscriptions for device events ([32badc9](https://github.com/Emina-M/edgehog/commit/32badc94a5705f3003ce66c1837430863a0217e3))
* implement retry logic for all deployment campaign operation types ([#1032](https://github.com/Emina-M/edgehog/issues/1032)) ([a1c6a81](https://github.com/Emina-M/edgehog/commit/a1c6a81de28019c9edadd90a70db5865b336856c))
* log outcome for successful or failed OTA operations ([#943](https://github.com/Emina-M/edgehog/issues/943)) ([#944](https://github.com/Emina-M/edgehog/issues/944)) ([fb0a7ba](https://github.com/Emina-M/edgehog/commit/fb0a7ba3410806f1a578a78c91cd9147353b127d))
* OTA updates can be canceled ([1daed60](https://github.com/Emina-M/edgehog/commit/1daed60e4fa6af858208f4b3fe3c3863006168c3)), closes [#266](https://github.com/Emina-M/edgehog/issues/266)
* Prevent deployment actions during conflicting campaigns ([#1058](https://github.com/Emina-M/edgehog/issues/1058)) ([71ccb38](https://github.com/Emina-M/edgehog/commit/71ccb38c4e98ee7b3f03228c5d822063d1ba54bc))
* **reconciler:** implement partial map comparison ([#980](https://github.com/Emina-M/edgehog/issues/980)) ([d43824f](https://github.com/Emina-M/edgehog/commit/d43824ff0a2f145808375cda4d32f9432c2707b7))
* remove device upon deletion finished in astarte ([6879933](https://github.com/Emina-M/edgehog/commit/687993393d51bdc15cd743da8041a8bd0187945b))
...
* add image_credentials_id to image identity ([#996](https://github.com/Emina-M/edgehog/issues/996)) ([de1b8dc](https://github.com/Emina-M/edgehog/commit/de1b8dcb9c85eb739e09314d3ecea07893e75576))
* avoid 422 in tenant deletion ([#1103](https://github.com/Emina-M/edgehog/issues/1103)) ([de8c0d9](https://github.com/Emina-M/edgehog/commit/de8c0d9a6f5a61c19ec222463046643b3154b9dc))
* avoid re-sending update messages ([#1081](https://github.com/Emina-M/edgehog/issues/1081)) ([a718c95](https://github.com/Emina-M/edgehog/commit/a718c95dc56ed291c6516e08245477bacc8b8637))
* **backend:** DeploymentEvent interface not working ([eed0dcb](https://github.com/Emina-M/edgehog/commit/eed0dcbb031653c791577f6bbe9677dcc65191c3))
* **backend:** log errors instead of crashing ([899f431](https://github.com/Emina-M/edgehog/commit/899f4315f01e67331057dcd11c4dbf0bee11c734))
* **bucket_storage:** image deletion ([5517c6e](https://github.com/Emina-M/edgehog/commit/5517c6ebd51b6a844bf13cf56ad54f9caddbec7c))
* **config:** Azure and edgehog config clash ([fa032dc](https://github.com/Emina-M/edgehog/commit/fa032dc4fca80063f872bf759d17af40df6f2b1d))
* **config:** Azure and edgehog config clash ([9c42aa6](https://github.com/Emina-M/edgehog/commit/9c42aa6acf39c68026824be83d48b24647b31db3))
...
* **containers:** remove usage of non-existing status_code deployment key ([#946](https://github.com/Emina-M/edgehog/issues/946)) ([8988cee](https://github.com/Emina-M/edgehog/commit/8988ceebe6c51201ad6ca4ad96355574a1380d41))
* correctly deploy resources only if not already deployed ([a6e4b78](https://github.com/Emina-M/edgehog/commit/a6e4b78573ad95d6f43e97824b2178450c094dc7))
* correctly relate image and container deployments ([b21ee6e](https://github.com/Emina-M/edgehog/commit/b21ee6e3ae2dd3ac10d7b025adcb2cb5428fd23e))
* device reconciliation not working ([ba1b025](https://github.com/Emina-M/edgehog/commit/ba1b02530283f69de9cafa5ce4a19cdb117de285))
* device registration triggers are available from `1.3.0-rc.0` ([#1096](https://github.com/Emina-M/edgehog/issues/1096)) ([dea4d3c](https://github.com/Emina-M/edgehog/commit/dea4d3cde31c1988d36f8029c8d9e0ed0b0b87cb))
* do not crash on available networks ([ee4111d](https://github.com/Emina-M/edgehog/commit/ee4111defbea75bc4bb0bc40fce17d2da79766b0))
* do not crash on available networks ([41fa223](https://github.com/Emina-M/edgehog/commit/41fa2233de37199300143b42b53920b1e61d02d8))
* double free of campaign slots ([664788b](https://github.com/Emina-M/edgehog/commit/664788baed26db6ded426f7dbb06b6d6f88e753e))
* double free of slots ([4884ad8](https://github.com/Emina-M/edgehog/commit/4884ad8e4fde1ee807d52dea3ec583d772e52c9c))
* ensure migrations can be successfully rolled back ([#949](https://github.com/Emina-M/edgehog/issues/949)) ([2981b1c](https://github.com/Emina-M/edgehog/commit/2981b1ccba3d3e674af1f1038625b1ecdf666270))
* Handle reconciler task replies ([bec0758](https://github.com/Emina-M/edgehog/commit/bec075870002b9e7c9213e7d9d0eeb2fd763d890))
* ignore prefetch_count in comparison of delivery policies ([#961](https://github.com/Emina-M/edgehog/issues/961)) ([f78f597](https://github.com/Emina-M/edgehog/commit/f78f597e24688b306759981d15b6314be8f4f340))
* include tenant in socket options ([d3c8921](https://github.com/Emina-M/edgehog/commit/d3c89212ca7c4fb25cab293985da144eac3f9188))
* Migrate old deployment states ([#1113](https://github.com/Emina-M/edgehog/issues/1113)) ([c7389e4](https://github.com/Emina-M/edgehog/commit/c7389e416987a0dcb67ad9a9396600b4cd60f330)), closes [#1086](https://github.com/Emina-M/edgehog/issues/1086)
...
* only reconcile when really needed ([#1072](https://github.com/Emina-M/edgehog/issues/1072)) ([49cca31](https://github.com/Emina-M/edgehog/commit/49cca31b81e4c2ccc5de34db258b58d2535f358f))
* Preserve existing data when migrating update_channels to channels ([6169fc0](https://github.com/Emina-M/edgehog/commit/6169fc0eb2953818bf6d956dbaf30dd2fb135c85))
* Prevent duplicate success in campaigns ([#1110](https://github.com/Emina-M/edgehog/issues/1110)) ([c39b387](https://github.com/Emina-M/edgehog/commit/c39b387667dd0cedeb2871938e7faf666fa7937d))
* reconcile backend snapshots ([#993](https://github.com/Emina-M/edgehog/issues/993)) ([2fd8d14](https://github.com/Emina-M/edgehog/commit/2fd8d149e19fba297692044d1fdcabe63536eee2))
...
* revert reconciliation condition ([#1079](https://github.com/Emina-M/edgehog/issues/1079)) ([cbf9a0f](https://github.com/Emina-M/edgehog/commit/cbf9a0f5297e6edf6e9bd15da605ddbc235bdcf4))
...
* update a deployment state to `:sent` only when necessary ([6e4371a](https://github.com/Emina-M/edgehog/commit/6e4371ad59fc5b4be48ebe250b3eaed12b151c74))
* updating is not deleting ([ed33f33](https://github.com/Emina-M/edgehog/commit/ed33f331583d6fcae926fb545913056f4bcddec5))
* updating is not deleting ([ad209c7](https://github.com/Emina-M/edgehog/commit/ad209c7a91a2b037b293c487f982bff07003816b))
* use correct default for `read_only_rootfs` ([24a7c72](https://github.com/Emina-M/edgehog/commit/24a7c7208d0f99c5e135c143c74727c2d55c994e))
* use correct default for `read_only_rootfs` ([2b08567](https://github.com/Emina-M/edgehog/commit/2b0856792e0745df9eda636026646a63905f5fd5))
* Wrong endpoint type in ServerToDevice for fileSizeBytes ([d43c948](https://github.com/Emina-M/edgehog/commit/d43c94851a57bec9a870be8a6c0c65729e3b3023))


### Miscellaneous Chores

* aggregate readiness ([b2ed432](https://github.com/Emina-M/edgehog/commit/b2ed432d5e39a973fc99013ace97f3dae376381c))
...
* enforce key-value structure for `Container.env` ([510217b](https://github.com/Emina-M/edgehog/commit/510217b1ab0c7a77040788931f7dffbf1fd90bb5))
* events are treated as events ([#953](https://github.com/Emina-M/edgehog/issues/953)) ([7753a77](https://github.com/Emina-M/edgehog/commit/7753a773a1da97c22f161c379b76cf784c1d2d79))
